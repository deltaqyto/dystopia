...
def main():
    ...
    texture_path = "C:\\Users\\Aditya\\PycharmProjects\\Game client\\Textures\\Walls.png"
    ...
    pygame.display.set_caption("Code snippet 2")
    screen = pygame.display.set_mode((1000, 700))

    for i in range(len(drawing)):
        for q in range(len(drawing[0])):
            screen.blit(textures[drawing[i][q]], (q * 32, i * 32))
